"""
Extraction pipeline test — commented out because binary test assets
were removed from version control to comply with Hugging Face Spaces
deployment restrictions (see deploy.yml for the clean-branch strategy).
